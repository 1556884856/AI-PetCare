...
public class AdminService : IAdminService
{
    ...
    public async Task<AppointmentDto> ConfirmAppointmentAsync(int id)
    {
        ...
        _messageBus.Publish("appointment.status", new AppointmentStatusEvent(a.Id, a.UserId, 1, $"您的预约（{a.Service.Name}）已确认，请按时到店。"));
    ...
    public async Task<AppointmentDto> CompleteAppointmentAsync(int id)
    {
        ...
        _messageBus.Publish("appointment.status", new AppointmentStatusEvent(a.Id, a.UserId, 2, $"您的预约（{a.Service.Name}）已完成，欢迎评价！"));
    ...
    public async Task<AppointmentDto> CancelAppointmentAsync(int id)
    {
        ...
        _messageBus.Publish("appointment.status", new AppointmentStatusEvent(a.Id, a.UserId, 3, $"您的预约（{a.Service.Name}）已被取消。"));
